Sitecore.PageModes.ChromeTypes.Rendering = Sitecore.PageModes.ChromeTypes.ChromeType.extend({
    ...
    setTimeOutRebuildScFieldValueItems: function ()
    {
        setTimeout(function ()
        {
    ...
    handleMessage: function (message, params, sender)
    {
        switch (message)
        {
            ...
            case "chrome:rendering:delete":
                this.deleteControl();
                this.setTimeOutRebuildScFieldValueItems();
                break;
    ...
    load: function ()
    {
        ...
        Sitecore.PageModes.ChromeControls.registerCommandRenderer("chrome:rendering:runcommand", Sitecore.PageModes.ChromeTypes.Rendering.runcommand, this);
